...
@Options({
  name: "ExtraItemsSideBar"
})
export default class ExtraItemsSideBar extends Vue {}
</script>
...
<template>
  <div class="extraItems">
    ...
    <a
      class="flex items-center py-2 px-4 text-gray-500 hover:text-green-400 hover:bg-black transition-all ease-in-out duration-100"
      href="/"
    >
      <svg
        class="block h-4 w-4"
